...
namespace RIBAStudentRegistration.Pages
{
    public class UnmatchedPassword
    {
        ...
        public UnmatchedPassword(IWebDriver browser)
        {
            driver = browser;
        ...
        [FindsBy(How = How.XPath, Using = "//input[@id='ConfirmPassword']/following-sibling::span")]
        public IWebElement Pwdunmatchedconfirmationtxt;
        ...
        public void RetypePassword()
        {
            ...
            ConfirmPasswordtxt.SendKeys("AutomationTester2");
        }
        ...
        public void PasswordUnmatche()
        {
            Thread.Sleep(2000);
            string ermessage = Pwdunmatchedconfirmationtxt.Text;


            driver.Url.Contains("uat-register.architecture.com/Students/Success").Should().BeFalse();
            ermessage.Contains("Your passwords do not match").Should().BeTrue();
